...
/**
 * ScreenshotUtil provides utility methods for capturing screenshots during test
 * execution.
 * 
 * Key Features:
...
public class ScreenshotUtil {
     ...
     * The screenshot filename includes the test name and a timestamp for
     * uniqueness.
     * 
     ...
     * This is a convenience method that calls captureScreenshot(driver,
     * "Screenshot").
     * 
     * @param driver WebDriver instance used to capture the screenshot.
     *               Must not be null and should be in an active state.
