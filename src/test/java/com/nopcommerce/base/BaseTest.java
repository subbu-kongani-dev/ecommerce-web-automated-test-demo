 ...
 * It provides common setup and teardown functionality for test execution.
 * 
 * Key Features:
 ...
 * - Integrates with TestListener for enhanced reporting
 * 
...
public class BaseTest {
     ...
     * Initializes WebDriver, loads configuration, and navigates to the application URL.
     * 
     * @param browser Optional parameter to specify browser type (chrome, firefox, edge).
     *                If not provided, uses the browser specified in config.properties.
     *                Can be passed from TestNG XML file for cross-browser testing.
     */
     ...
     * Captures screenshots on test failure and closes the browser session.
     * 
     * @param result ITestResult object containing test execution details including:
     *               - Test name
     *               - Test status (SUCCESS, FAILURE, SKIP)
     *               - Exception details if test failed
     *               - Test execution time
     *               
     * Screenshot Capture Logic:
     * - Only captures screenshot if test status is FAILURE
     * - Screenshot filename includes test name and timestamp
     * - Screenshots are saved to the path specified in config.properties
     */
     ...
     * 
     * @param status Integer status code from ITestResult
     *               1 = SUCCESS
     *               2 = FAILURE
     *               3 = SKIP
